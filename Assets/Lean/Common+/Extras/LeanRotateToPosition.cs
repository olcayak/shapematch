...
namespace Lean.Common
{
    ...
    public class LeanRotateToPosition : MonoBehaviour
    {
        ...
        public PositionType Position { set { position = value; } get { return position; } }
        [FSA("Position")] [SerializeField] private PositionType position;
        ...
        [FSA("Threshold")] [SerializeField] private float threshold = 0.1f;

        /// <summary>If you enable this the rotation will be reversed.</summary>
        public bool Invert { set { invert = value; } get { return invert; } }
        [FSA("Invert")] [SerializeField] private bool invert;
        ...
        [FSA("RotateTo")] [SerializeField] private RotateType rotateTo;
        ...
        [FSA("Dampening")] [FSA("Damping")] [SerializeField] private float damping = 10.0f;
